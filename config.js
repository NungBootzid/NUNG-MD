...
global.botintro = 'Hallo, Kenalin saya Yuki BOT Saya akan membantu Anda kapan pun & Dimana pun, Saya asisten bot WhatsApp yang di buat oleh *ᴹᴿ᭄ King Of Bear ×፝֟͜×* x NungBootz Saya di rilis pada tanggal\n🗓 ️_16/10/2022_'
global.intro = 'https://telegra.ph/file/6ab4daac226292a112540.jpg'
/*============== GLOBAL BIO ==============*/
global.nameowner = 'ᴹᴿ᭄ NungBootz ×፝֟͜×'
global.umurowner = '22'
global.asalowner = 'Amerika Serikat, New York'
global.nomorowner = 'wa.me/6287750278761
global.pacarowner = 'Kepo amat sih;v'

/*============== TEXT ==============*/
global.wait = '```𝙇𝙤𝙖𝙙𝙞𝙣𝙜...```'sabar todd🗿
